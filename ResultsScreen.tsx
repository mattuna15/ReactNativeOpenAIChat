  ...
  return (
    ...
    >
      <View style={resultsScreenStyles.header}>
        <TouchableOpacity
          style={resultsScreenStyles.backButton}
          onPress={navigation.goBack}
        >
          <Text style={resultsScreenStyles.backButtonText}>← Back</Text>
        </TouchableOpacity>
        <Text style={[resultsScreenStyles.title, dynamicStyles.title]}>
          AI Response
        </Text>
      </View>
      ...
      >
        <View
          style={[resultsScreenStyles.promptCard, dynamicStyles.promptCard]}
        >
          <Text
            style={[resultsScreenStyles.cardTitle, dynamicStyles.cardTitle]}
          >
            Your Prompt:
          </Text>
          <Text
            style={[resultsScreenStyles.promptText, dynamicStyles.promptText]}
          >
            {prompt}
          </Text>
        </View>
        ...
        <View
          style={[resultsScreenStyles.responseCard, dynamicStyles.responseCard]}
        >
          <Text
            style={[resultsScreenStyles.cardTitle, dynamicStyles.cardTitle]}
          >
          ...
          <Text
            style={[
              resultsScreenStyles.responseText,
              dynamicStyles.responseText,
            ]}
          >
